    ...
    return (
        <div
            ...
            <div className='flex flex-col items-center justify-center text-white md:w-1/3 px-6'>
                ...
                <div className='text-4xl text-white font-bold pb-6 text-center md:text-justify'>
                    SQL Cloud Account?
                </div>
            </div>
            <div className='pb-10 md:pb-0'>
                <button
                    className='flex items-center justify-center text-white gap-2 bg-secondary-600 rounded-3xl p-3 md:w-full'>
