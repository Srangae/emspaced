    ...
    return (
        <NikolasLayout>
            <div className="nicolas_sm_contact">
                <div className="nicolas_sm_page_title">
                    <div className="container">
                        <div className="page_title_in">
                            <h3>SQL ACCOUNT</h3>
                            <div className='flex items-center justify-center py-6 text-2xl'>Beyond an accounting
                                software
                            </div>
                        </div>
                ...
                <div className='flex items-center justify-center bg-gradient-to-r from-purple-500 to-purple-900 w-full'>
                    <div className='w-5/6 flex flex-col gap-5 py-6 text-white'>
                        <div className='text-center text-6xl py-6'>
                ...
                <div className='flex flex-col items-center justify-center p-10 text-center gap-10'>
                        ...
                        <div className="service_list">
                            <ul>
                                <li>
                                    <div className="list_inner">
                                        ...
                                        <div className="flex flex-col gap-10 py-5">
                                            <div className='text-center font-bold text-xl italic'>
                                ...
                                <li>
                                    <div className="list_inner">
                                        <span>06</span>
                                        <h3>Sales and Service Tax / GST</h3>
                                        <div className="flex flex-col gap-10 py-5">
                                            <div className='text-center font-bold text-xl italic'>
                            ...
                            <div className='flex md:flex-row flex-col items-center justify-center w-full gap-5 py-6'>
                                <Link href='/sql-account-features'
                                      className='flex items-center justify-center bg-purple-600 text-white w-full md:w-1/5 rounded-3xl p-5'>
                                    <button>
                                        FULL FEATURES
                                    </button>
                                </Link>
                                ...
                                <Link href='/sql-account-features#special_industry'
                                      className='flex items-center justify-center bg-white text-purple-600 w-full md:w-1/5 rounded-3xl p-5'>
                                    <button>
                                        SPECIAL INDUSTRIES
                                    </button>
                                </Link>
                    ...
                    <div
                        className='flex items-center justify-center bg-gradient-to-r from-neutral-300 to-stone-400 w-full'>
                        <div className='w-5/6 flex flex-col gap-5 py-6 '>
                            <div className='text-center text-5xl py-6 text-emerald-900'>
                ...
                <div className='flex flex-col items-center justify-center bg-white py-10 gap-5 text-center'>
