                ...
                <div className='flex flex-col items-center justify-center p-10 text-center gap-10'>
                    ...
                    <div
                        ...
                        <div className='w-5/6 flex flex-col gap-5 py-6 '>
                            <div className='text-center text-5xl py-6 text-primary-900 font-bold'>
                                SQL Account - Recommended Server Specification
                            </div>

                            <div className='flex flex-col gap-10 '>
                                <div className='flex flex-col gap-2'>
                                    <div className='font-bold text-primary-900 text-2xl'>
                                        Processor
                                    </div>
                                    <div className='text-secondary-800 text-lg'>
